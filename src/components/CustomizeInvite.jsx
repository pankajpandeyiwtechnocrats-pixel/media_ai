...
const CustomizeInvite = () => {
  ...
  const [pages, setPages] = useState([
    {
      ...
      textLines: [
        { id: 'l1', label: "Host Name", content: "Mrs. Joti Verma", style: { top: '30%', fontSize: '36px', fontFamily: 'serif' } },
        { id: 'l2', label: "Blessing Text", content: "with the heavenly blessing Singh,", style: { top: '40%', fontSize: '12px', fontFamily: 'serif' } },
        { id: 'l3', label: "Secondary Text", content: "of their a brother", style: { top: '43%', fontSize: '12px', fontFamily: 'serif' } },
        { id: 'l4', label: "Event Type", content: "Wedding Ceremony", style: { top: '50%', fontSize: '24px', fontFamily: 'serif', color: '#9d174d' } },
        { id: 'l5', label: "Bride Name", content: "Amusha", style: { top: '58%', fontSize: '36px', fontFamily: 'serif', color: '#831843' } },
        { id: 'l6', label: "Connecting Text", content: "weds", style: { top: '65%', fontSize: '16px', fontFamily: 'serif' } },
        { id: 'l7', label: "Groom Name", content: "Nishanth", style: { top: '70%', fontSize: '36px', fontFamily: 'serif', color: '#831843' } },
      ]
    },
    {
      id: 2,
  ...
  return (
    <div className="h-screen flex flex-col bg-[#f5f5f5] overflow-hidden font-sans">
      ...
      {/* TOP NAVBAR: Modeled after reference image */}
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* LEFT SIDEBAR: Page list with Clip Ordering */}
        ...
        {/* CENTER: Invitation Canvas with Static Background */}
        <div className="flex-1 flex items-center justify-center p-8 bg-gray-200/50">
          <div className="relative h-full max-h-[85vh] aspect-[9/16] bg-white shadow-2xl rounded-sm overflow-hidden border-[10px] border-white">
            <img src={activePage.backgroundImage} className="absolute inset-0 w-full h-full object-cover" />
            ...
            <div className="absolute inset-0 select-none">
              {activePage.textLines.map((line) => (
                <div 
                  ...
                  className="px-10 leading-snug transition-all duration-300"
                >
                  {line.content}
                </div>
              ))}
        ...
        {/* RIGHT SIDEBAR: Input Fields for Active Page only */}
            ...
            {activePage.textLines.map((line) => (
              <div key={line.id} className="space-y-1">
                ...
                <div className="flex items-center border rounded-lg bg-white shadow-sm focus-within:ring-2 focus-within:ring-pink-500/20 focus-within:border-pink-500 overflow-hidden transition-all">
                  ...
                  />
                  <div className="px-3 py-1 bg-gray-50 border-l text-[10px] font-bold text-gray-300">10</div>
                </div>
              </div>
            ))}
          </div>
