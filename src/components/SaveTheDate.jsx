...
// 1. FIXED: Renamed component to match the export
const SaveTheDate = () => {
    ...
    <div className="bg-white min-h-screen pb-20 relative">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="max-w-2xl">
            <h1 className="text-3xl md:text-4xl font-black text-gray-900 mb-4">
              SAVE THE DATE <span className="text-pink-600">INVITATIONS</span>
            </h1>
            {/* 3. FIXED: Updated text to match Save the Date context */}
            <p className="text-gray-700 font-bold mb-2">Sacred, vibrant & deeply traditional</p>
            <p className="text-gray-500 text-sm leading-relaxed">
              Create stunning save the date invitation videos with our Invitation Video Maker. Choose from beautiful templates, personalize your content, and download your video invitation instantly.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex flex-wrap gap-3 items-center">
           ...
           <span className="text-gray-500 font-bold mr-4">22 designs</span>
           {filters.map((f, i) => {
             let path = "#";
             ...
             return (
               <Link 
                  key={i} 
                  to={path}
                  // 4. FIXED: Condition now checks for "Save the Date" to highlight the button
                  className={`px-5 py-2 rounded-full border text-sm font-medium transition ${f === "Save the Date" ? 'border-pink-500 text-pink-600 bg-pink-50' : 'border-gray-200 text-gray-600 hover:border-pink-300'}`}
               >
                 {f}
               </Link>
             );
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-8">
        {designs.map((design, i) => (
          <div 
            ...
            onClick={() => handleVideoClick(design)}
          >
